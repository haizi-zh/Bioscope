...
//#include "include\picontrollererrors.h"
	...
	currentAxis_(3)
{
	...
	// Description
	CreateProperty(MM::g_Keyword_Description, "Physik Instrumente (PI) E761 Adapter / Z-Stage", MM::String, true);
...
int CPI_E761_ZStage::Initialize()
{
	...
	// StepSize
	CPropertyAction* pAct = new CPropertyAction (this, &CPI_E761_ZStage::OnStepSizeUm);
...
int CPI_E761_ZStage::OnStepSizeUm(MM::PropertyBase* pProp, MM::ActionType eAct)
{
	if (eAct == MM::BeforeGet)
	{
...
int CPI_E761_ZStage::OnSoftLowerLimit(MM::PropertyBase* pProp, MM::ActionType eAct)
{
	MMThreadGuard guard(g_PI_ThreadLock);
...
int CPI_E761_ZStage::OnSoftHigherLimit(MM::PropertyBase* pProp, MM::ActionType eAct)
{
	MMThreadGuard guard(g_PI_ThreadLock);
...
int CPI_E761_ZStage::OnTravelHighEnd(MM::PropertyBase* pProp, MM::ActionType eAct)
{
	MMThreadGuard guard(g_PI_ThreadLock);
...
int CPI_E761_ZStage::OnTravelLowEnd(MM::PropertyBase* pProp, MM::ActionType eAct)
{
	MMThreadGuard guard(g_PI_ThreadLock);
...
int CPI_E761_ZStage::OnVelControl(MM::PropertyBase* pProp, MM::ActionType eAct)
{
	MMThreadGuard guard(g_PI_ThreadLock);
...
int CPI_E761_ZStage::OnCurrentAxis(MM::PropertyBase* pProp, MM::ActionType eAct)
{
	if (eAct == MM::BeforeGet)
	{
	...
	stepSizeUm_(0.001)
{
	...
	// Description
	CreateProperty(MM::g_Keyword_Description, "Physik Instrumente (PI) E761 Adapter / XY-Stage", MM::String, true);
}
...
int CPI_E761_XYStage::Initialize()
{
	...
	// StepSize
	CPropertyAction* pAct = new CPropertyAction (this, &CPI_E761_XYStage::OnStepSizeUm);
	CreateProperty("StepSizeUm", "0.001", MM::Float, false, pAct);
	...
	CreateProperty("X position", "0.0", MM::Float, false, pAct);
	pAct = new CPropertyAction (this, &CPI_E761_XYStage::OnYPosition);
	CreateProperty("Y position", "0.0", MM::Float, false, pAct);
...
int CPI_E761_XYStage::GetLimitsUm(double& xMin, double& xMax, double& yMin, double& yMax)
{
	MMThreadGuard guard(g_PI_ThreadLock);
...
int CPI_E761_XYStage::GetStepLimits(long& xMin, long& xMax, long& yMin, long& yMax)
{
...
int CPI_E761_XYStage::OnStepSizeUm(MM::PropertyBase* pProp, MM::ActionType eAct)
{
	if (eAct == MM::BeforeGet)
	{
		pProp->Set(stepSizeUm_);
...
int CPI_E761_XYStage::OnXPosition(MM::PropertyBase* pProp, MM::ActionType eAct)
{
	if (eAct == MM::BeforeGet)
	{
		double x, y;
...
int CPI_E761_XYStage::OnYPosition(MM::PropertyBase* pProp, MM::ActionType eAct)
{
	if (eAct == MM::BeforeGet)
	{
		double x, y;
...
int CPI_E761_XYStage::OnTravelRange(MM::PropertyBase* pProp, MM::ActionType eAct)
{
	if (eAct == MM::BeforeGet)
	{
		MMThreadGuard guard(g_PI_ThreadLock);
		...
		char str[1024];
		snprintf(str, 1024, "Travel range: axis 1: %g~%gum / axis 2: %g~%gum", lowArray[0], highArray[0], lowArray[1], highArray[1]);
		pProp->Set(str);
	}
